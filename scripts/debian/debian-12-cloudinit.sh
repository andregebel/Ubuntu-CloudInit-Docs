...
virt-customize -a /var/lib/vz/template/iso/debian-12-generic-amd64.qcow2 --root-password password:Relation123!
virt-customize -a /var/lib/vz/template/iso/debian-12-generic-amd64.qcow2 --run-command "echo -n > /etc/machine-id"
